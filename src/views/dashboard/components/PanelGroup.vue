    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('newVisitis')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="totalUser" :duration="2600" class="card-panel-num"/>人
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('messages')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">网站运营天数</div>
          <count-to :start-val="0" :end-val="totalDate" :duration="3000" class="card-panel-num"/>天
        </div>
      </div>
    </el-col>
    <!-- <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
